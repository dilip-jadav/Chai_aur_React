...
function App() {
  ...
  return (
    ...
    <div  className='w-full h-screen duration-200'
      ...
      <div className='fixed flex flex-wrap justify-center bottom-23 inset-x-0 px-2'>
        ...
        style={{backgroundColor:"green"}} >Grenn </button>
        ...
        <button onClick={()=>setColor("white")} className='outline-none px-4 py-1 rounded-full text-blck shadow-lg'
